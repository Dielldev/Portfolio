...
const Achievements: React.FC = () => {
    const [selectedCategory, setSelectedCategory] = useState<'all' | 'achievement' | 'certificate'>('all');
    ...
    const allItems: (Achievement | Certificate)[] = [...achievements, ...certificates];
        ...
        <section className="bg-[#0e1420] text-white py-16 section-transition" id="achievements">
            <div className="container mx-auto px-4">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    {(['all', 'achievement', 'certificate'] as const).map((category) => (
                        <button
                            key={category}
                        ...
                        >
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    {item.type === 'certificate' && 'credentialUrl' in item && (
                                        <a
                                    ...
                                    {item.type === 'achievement' && 'description' in item && item.description && (
